...
public interface PermissionRegistrationManager {
     ...
     * dynamic permissions (e.g., check-specific permissions like "cult.exempt.checkname")
     * are available for autocomplete before Cult attempts to use them. This is
     ...
     *
     * @param name         The permission node to register (e.g., "cult.exempt").
