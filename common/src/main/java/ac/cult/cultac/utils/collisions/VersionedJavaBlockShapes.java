...
final class VersionedJavaBlockShapes {
    ...
    private static Optional<CollisionBox> firstMatch(List<ShapeOverride> overrides, CultPlayer player, BlockData state, int x, int y, int z) {
    ...
    private static Optional<CollisionBox> paleMossCarpetMovement(CultPlayer player, BlockData state, int x, int y, int z) {
    ...
    private record ShapeOverride(Predicate<BlockData> matcher, ShapeFactory factory) {
        ...
        Optional<CollisionBox> create(CultPlayer player, BlockData state, int x, int y, int z) {
