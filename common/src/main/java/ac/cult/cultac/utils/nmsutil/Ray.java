...
public class Ray implements Cloneable {
    ...
    public Ray(CultPlayer player, double x, double y, double z, float xRot, float yRot) {
    ...
    public static Vector calculateDirection(CultPlayer player, float xRot, float yRot) {
