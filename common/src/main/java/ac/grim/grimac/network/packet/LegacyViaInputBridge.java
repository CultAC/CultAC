 ...
 * onto the 1.21.2+ input bitset. Their payload values remain Via's concern; Grim
...
public final class LegacyViaInputBridge extends ChannelInboundHandlerAdapter {
    public static final String HANDLER_NAME = "grim-legacy-via-input";
    ...
    private static boolean handleLegacySteer(GrimPlayer player) {
    ...
    private static boolean handleLegacySneak(GrimPlayer player, boolean sneaking) {
