...
import ac.grim.grimac.network.event.PacketEvent;
...
public final class NmsPacketUtil {
    ...
    public static MovePlayerData readMovePlayer(ServerboundMovePlayerPacket packet, GrimPlayer player) {
    ...
    public static ServerboundMovePlayerPacket withOnGround(ServerboundMovePlayerPacket packet, GrimPlayer player, boolean onGround) {
