...
@Getter
public class ActionManager extends GrimProcessor implements CheckListener, ClientTickEndListener {
    ...
    public ActionManager(GrimPlayer grimPlayer) { super(grimPlayer); }
    ...
    public void onPlayerInput(PacketReceiveEvent event, GrimPlayer player, ServerboundPlayerInputPacket packet) {
        ...
        player.packetStateData.knownInput = new ac.grim.grimac.utils.data.KnownInput(
    ...
    @GrimPacketHandler
    public void onMovePlayerPos(PacketReceiveEvent event, GrimPlayer player, ServerboundMovePlayerPacket.Pos packet) {
        clearMainHandUseAfterSlotChange();
    }

    @GrimPacketHandler
    public void onMovePlayerRot(PacketReceiveEvent event, GrimPlayer player, ServerboundMovePlayerPacket.Rot packet) {
        clearMainHandUseAfterSlotChange();
    }

    @GrimPacketHandler
    public void onMovePlayerPosRot(PacketReceiveEvent event, GrimPlayer player, ServerboundMovePlayerPacket.PosRot packet) {
        clearMainHandUseAfterSlotChange();
    }

    @GrimPacketHandler
    public void onMovePlayerStatusOnly(PacketReceiveEvent event, GrimPlayer player, ServerboundMovePlayerPacket.StatusOnly packet) {
        clearMainHandUseAfterSlotChange();
    }
    ...
    public void onSetHeldSlot(ac.grim.grimac.network.event.PacketSendEvent event, GrimPlayer player, net.minecraft.network.protocol.Packet<?> packet) {
        this.blocking = false;
        player.packetStateData.setSlowedByUsingItem(false);
    }
