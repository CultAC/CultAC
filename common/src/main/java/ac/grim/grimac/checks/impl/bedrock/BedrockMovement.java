package ac.grim.grimac.checks.impl.bedrock;
...
public final class BedrockMovement extends Check implements PostPredictionListener {
    ...
    public BedrockMovement(GrimPlayer player) {
        super(player, CheckInfo.builder()
                .name("BedrockMovement")
                .stableKey("grim.bedrock.movement")
    ...
    public void onPredictionComplete(PredictionComplete predictionComplete) {
        ...
        if (endpointFlag != null) {
            ...
            double threshold = GrimAPI.INSTANCE.getConfigManager().getBedrockMovementPositionFlagThreshold();
