...
public class PointThree implements UncertaintyHandler {
    ...
    private boolean controlsVerticalMovement(GrimPlayer player, PredictionResult result) {
    ...
    public double getOffsetHorizontal(GrimPlayer player, PredVector vector, SimulationContext context, PredictionResult lastResult) {
