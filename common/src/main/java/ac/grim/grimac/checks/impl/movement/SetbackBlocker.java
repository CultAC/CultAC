...
public class SetbackBlocker extends GrimProcessor implements CheckListener {
    ...
    private void handleMovePlayer(final PacketReceiveEvent event, ServerboundMovePlayerPacket movePacket,
        ...
        if (player.isDisabled()) { return; } // Let's avoid letting people disable grim with grim.nomodifypackets
    ...
    private void handleMoveVehicle(final PacketReceiveEvent event) {
        ...
        // The client can send its first vehicle move before Grim's delayed passenger task runs.
        ...
        // movement. Only block this for Grim-owned vehicle setbacks; ordinary server
