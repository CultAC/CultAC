...
import ac.grim.grimac.checks.impl.prediction.stage.uncertainty.BoatTransform;
...
public class BoatData {
    ...
    public Vec3 adjustStuckSpeedMultiplierForCurrentTick(GrimPlayer player, SimulationContext context, Vec3 multiplier) {
    ...
    public void tick(GrimPlayer player) {
    ...
    private static boolean hasCompletedPassengerTickAfterObservedMount(GrimPlayer player, int boatEntityId) {
    ...
    private static SimpleCollisionBox getControlledBoatCurrentBox(GrimPlayer player, PacketEntity vehicle) {
    ...
    public static BoatStatusSample sampleStatus(GrimPlayer player, SimpleCollisionBox box) {
    ...
    public static float getGroundFriction(GrimPlayer player, SimpleCollisionBox axisalignedbb) {
    ...
    private static BoatEntityStatus isUnderwater(GrimPlayer player, SimpleCollisionBox axisalignedbb) {
    ...
    private static double getInWaterLevel(GrimPlayer grimPlayer, SimpleCollisionBox axisalignedbb) {
        int i = GrimMath.floor(axisalignedbb.minX);
        int j = GrimMath.ceil(axisalignedbb.maxX);
