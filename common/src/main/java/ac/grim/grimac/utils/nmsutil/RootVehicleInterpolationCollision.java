...
public final class RootVehicleInterpolationCollision {
    ...
    public static boolean shouldShiftRootInterpolationTarget(GrimPlayer player, PacketEntity vehicle,
    ...
    private static boolean hasNoRootVehicleEntityCollision(GrimPlayer player, PacketEntity vehicle,
    ...
    private static boolean hasNoLocalPlayerCollision(GrimPlayer player, PacketEntity vehicle,
    ...
    private static Vec3 localPlayerPositionAtRootEntityTick(GrimPlayer player) {
    ...
    private static boolean localPlayerIsPushable(GrimPlayer player, Vec3 position) {
