...
public final class NmsBlockBreakResolver {
    ...
    public static boolean applyBlockBreak(GrimPlayer player, BlockPos blockPosition) {
        ...
        for (PlacementResult.ChangedBlock changedBlock : result.getChangedBlocks()) {
            BlockData data = ac.grim.grimac.network.protocol.util.SpigotConversionUtil.fromNmsBlockState(changedBlock.state());
