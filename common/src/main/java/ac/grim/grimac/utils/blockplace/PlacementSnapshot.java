...
public final class PlacementSnapshot {
    ...
    public static PlacementSnapshot capture(GrimPlayer player, BlockPlace place) {
    ...
    public static PlacementSnapshot captureBreak(GrimPlayer player, BlockPos blockPosition) {
