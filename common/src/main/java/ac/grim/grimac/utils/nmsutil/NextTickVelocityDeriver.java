...
public final class NextTickVelocityDeriver {
    ...
    public static Set<Vec3> beforeBlockEffects(GrimPlayer player, PredictionResult result, PredictionResult lastPrediction, Vec3 diff) {
        return findVelocities(player, result, lastPrediction, diff, false);
    }

    private static Set<Vec3> findVelocities(GrimPlayer player, PredictionResult result, PredictionResult lastPrediction, Vec3 diff, boolean geysers) {
    ...
    private static Set<Vec3> findVelocitiesForSingleReality(GrimPlayer player, PredictionResult result, PredictionResult lastPrediction, Vec3 diff, boolean geysers) {
    ...
    private static Set<Vec3> transformCandidatesForNextTick(GrimPlayer player, PredictionResult result, PredictionResult lastPrediction, Set<Vec3> candidates, boolean geysers) {
