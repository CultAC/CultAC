...
public final class WaterCurrent {
    ...
    public static Vec3 calculateWaterCurrent(GrimPlayer player, SimulationContext context, Vec3 position, Vec3 velocityBeforeCurrent) {
    ...
    public static Vec3 calculateTouchedNonPlayerWaterCurrent(GrimPlayer player, SimpleCollisionBox entityBox) {
    ...
    public static SimpleCollisionBox getWaterCurrentInteractionBox(GrimPlayer player, SimulationContext context, Vec3 position) {
        PacketEntity vehicle = context.getVehicle();
        if (vehicle != null) {
        ...
        // rather than the mutable live GrimPlayer pose.
