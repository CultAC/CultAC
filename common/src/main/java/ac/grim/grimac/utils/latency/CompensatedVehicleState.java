...
public final class CompensatedVehicleState implements Debuggable {
    ...
    CompensatedVehicleState(GrimPlayer player, CompensatedEntities entities) {
        this.player = player;
    ...
    public void debug(StringReturner details) {
        ac.grim.grimac.checks.impl.prediction.DebugHandler debugHandler =
    ...
    /**
     * Returns whether either Grim's immediate server timeline or its
