...
import ac.grim.grimac.bedrock.protocol.BedrockMoveFrame;
...
public final class BedrockPredictionDebug {
    ...
    public static BedrockMovementObservation currentObservation(GrimPlayer player, PredictionResult result) {
    ...
    public static void sendMovementVerbose(GrimPlayer player, PredictionResult result, String debugLog) {
        if (!player.isBedrockMovement()
                || player.bedrockState == null
                || result == null) {
            return;
        ...
        if (!GrimAPI.INSTANCE.getConfigManager().isVerboseBedrockMovement()
                || result.isExempt()
        ...
        GrimAPI.INSTANCE.getAlertManager().sendVerbose(
                net.kyori.adventure.text.serializer.legacy.LegacyComponentSerializer.legacyAmpersand().deserialize(message.toString()), null);
    }

    public static boolean shouldRecordMovementDebug(GrimPlayer player, PredictionResult result) {
        ...
        Function<Object, Object> active = GrimAPI.INSTANCE.getExternalAPI()
    ...
    private static void publishMovementDebug(GrimPlayer player, PredictionResult result, String debugLog) {
        ...
        Function<Object, Object> active = GrimAPI.INSTANCE.getExternalAPI()
                .getFunction("cultac.bedrock.movementDebug.active");
        Function<Object, Object> record = GrimAPI.INSTANCE.getExternalAPI()
    ...
    public static void appendDetails(GrimPlayer player, StringBuilder sb, PredictionResult result) {
