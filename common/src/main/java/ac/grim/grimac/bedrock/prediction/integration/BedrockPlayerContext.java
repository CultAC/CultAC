...
import ac.grim.grimac.bedrock.protocol.BedrockClientPoseState;
...
record BedrockPlayerContext(
    ...
    static AttributeState attributes(GrimPlayer player) {
    ...
    private static EquipmentState equipment(GrimPlayer player, SimulationContext context) {
    ...
    private static int riptideLevel(GrimPlayer player, SimulationContext context) {
    ...
    private static boolean wearingElytra(GrimPlayer player) {
        if (player == null || player.getInventory() == null) {
            return false;
        }
    ...
    private static BedrockEffectState effects(GrimPlayer player, SimulationContext context) {
    ...
    private static int effectLevel(GrimPlayer player, CompensatedEntities entities, String... names) {
        if (names == null) {
            return 0;
        }
