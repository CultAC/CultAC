...
import ac.grim.grimac.bedrock.prediction.BedrockTrustedEndOfTickVelocity;
...
import ac.grim.grimac.bedrock.protocol.BedrockAuthInputPluginMessage;
import ac.grim.grimac.bedrock.protocol.BedrockClientAction;
...
public final class BedrockAuthInputPluginMessageListener {
    ...
    private void processAuthInputFrame(GrimPlayer player, BedrockAuthInputFrame frame) {
    ...
    private Vec3 processAuthInputFrameAndSelectVelocity(GrimPlayer player, BedrockAuthInputFrame frame) {
    ...
    private void processClientAction(GrimPlayer player, BedrockClientAction action) {
        switch (action) {
