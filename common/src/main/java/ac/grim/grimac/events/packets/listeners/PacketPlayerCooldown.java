...
import ac.grim.grimac.player.GrimPlayer.TrackedTransaction;
...
public class PacketPlayerCooldown {
    ...
    //HIGH
    @GrimPacketHandler
    public void onCooldown(PacketSendEvent event, GrimPlayer player, ClientboundCooldownPacket packet) {
