...
import ac.grim.grimac.checks.impl.badpackets.BadPacketsVehicle;
...
import ac.grim.grimac.events.packets.blockplace.PlaceHandler;
import ac.grim.grimac.manager.player.CheckManager;
...
import ac.grim.grimac.network.PacketHandlerScanner;
import ac.grim.grimac.network.PacketReceiveHandler;
import ac.grim.grimac.network.PacketSendHandler;
...
import ac.grim.grimac.utils.blockplace.NmsBlockBreakResolver;
...
import ac.grim.grimac.utils.latency.BlockPredictionAckSender;
...
public class CheckManagerListener {
    ...
    @GrimPacketHandler
    public void onChunkBatchReceived(PacketReceiveEvent event, GrimPlayer player, ServerboundChunkBatchReceivedPacket packet) {
        processInterveningReceive(event, player);
    }

    @GrimPacketHandler
    public void onCookieResponse(PacketReceiveEvent event, GrimPlayer player, ServerboundCookieResponsePacket packet) {
        processInterveningReceive(event, player);
    }

    @GrimPacketHandler
    public void onPingRequest(PacketReceiveEvent event, GrimPlayer player, ServerboundPingRequestPacket packet) {
        processInterveningReceive(event, player);
    }

    @GrimPacketHandler
    public void onResourcePack(PacketReceiveEvent event, GrimPlayer player, ServerboundResourcePackPacket packet) {
        processInterveningReceive(event, player);
    }
    ...
    @GrimPacketHandler
    public void onChat(PacketReceiveEvent event, GrimPlayer player, ServerboundChatPacket packet) {
        processGenericReceive(event, player);
    }
    ...
    @GrimPacketHandler
    public void onChatCommandSigned(PacketReceiveEvent event, GrimPlayer player, ServerboundChatCommandSignedPacket packet) {
        processGenericReceive(event, player);
    }

    @GrimPacketHandler
    public void onEditBook(PacketReceiveEvent event, GrimPlayer player, ServerboundEditBookPacket packet) {
        processGenericReceive(event, player);
    }

    // Teleport acknowledgements are handled separately and must not clear the mounted-teleport latch.
    @GrimPacketHandler
    public void onBlockEntityTagQuery(PacketReceiveEvent event, GrimPlayer player, ServerboundBlockEntityTagQueryPacket packet) {
        processGenericReceive(event, player);
    }

    @GrimPacketHandler
    public void onChangeDifficulty(PacketReceiveEvent event, GrimPlayer player, ServerboundChangeDifficultyPacket packet) {
        processGenericReceive(event, player);
    }

    @GrimPacketHandler
    public void onChangeGameMode(PacketReceiveEvent event, GrimPlayer player, ServerboundChangeGameModePacket packet) {
        processGenericReceive(event, player);
    }

    @GrimPacketHandler
    public void onChatAck(PacketReceiveEvent event, GrimPlayer player, ServerboundChatAckPacket packet) {
        processGenericReceive(event, player);
    }

    @GrimPacketHandler
    public void onChatSessionUpdate(PacketReceiveEvent event, GrimPlayer player, ServerboundChatSessionUpdatePacket packet) {
        processGenericReceive(event, player);
    }

    @GrimPacketHandler
    public void onConfigurationAcknowledged(PacketReceiveEvent event, GrimPlayer player, ServerboundConfigurationAcknowledgedPacket packet) {
        processGenericReceive(event, player);
    }

    @GrimPacketHandler
    public void onCustomClickAction(PacketReceiveEvent event, GrimPlayer player, ServerboundCustomClickActionPacket packet) {
        processGenericReceive(event, player);
    }

    @GrimPacketHandler
    public void onDebugSubscriptionRequest(PacketReceiveEvent event, GrimPlayer player, ServerboundDebugSubscriptionRequestPacket packet) {
        processGenericReceive(event, player);
    }

    @GrimPacketHandler
    public void onEntityTagQuery(PacketReceiveEvent event, GrimPlayer player, ServerboundEntityTagQueryPacket packet) {
        processGenericReceive(event, player);
    }

    @GrimPacketHandler
    public void onJigsawGenerate(PacketReceiveEvent event, GrimPlayer player, ServerboundJigsawGeneratePacket packet) {
        processGenericReceive(event, player);
    }

    @GrimPacketHandler
    public void onLockDifficulty(PacketReceiveEvent event, GrimPlayer player, ServerboundLockDifficultyPacket packet) {
        processGenericReceive(event, player);
    }

    @GrimPacketHandler
    public void onRecipeBookChangeSettings(PacketReceiveEvent event, GrimPlayer player, ServerboundRecipeBookChangeSettingsPacket packet) {
        processGenericReceive(event, player);
    }

    @GrimPacketHandler
    public void onRecipeBookSeenRecipe(PacketReceiveEvent event, GrimPlayer player, ServerboundRecipeBookSeenRecipePacket packet) {
        processGenericReceive(event, player);
    }

    @GrimPacketHandler
    public void onSeenAdvancements(PacketReceiveEvent event, GrimPlayer player, ServerboundSeenAdvancementsPacket packet) {
        processGenericReceive(event, player);
    }

    @GrimPacketHandler
    public void onSetGameRule(PacketReceiveEvent event, GrimPlayer player, ServerboundSetGameRulePacket packet) {
        processGenericReceive(event, player);
    }

    @GrimPacketHandler
    public void onSetJigsawBlock(PacketReceiveEvent event, GrimPlayer player, ServerboundSetJigsawBlockPacket packet) {
        processGenericReceive(event, player);
    }

    @GrimPacketHandler
    public void onSetTestBlock(PacketReceiveEvent event, GrimPlayer player, ServerboundSetTestBlockPacket packet) {
        processGenericReceive(event, player);
    }
    ...
    @GrimPacketHandler
    public void onTestInstanceBlockAction(PacketReceiveEvent event, GrimPlayer player, ServerboundTestInstanceBlockActionPacket packet) {
        processGenericReceive(event, player);
    }

    @GrimPacketHandler
    public void onRenameItem(PacketReceiveEvent event, GrimPlayer player, ServerboundRenameItemPacket packet) {
        processGenericReceive(event, player);
    }
    ...
    @GrimPacketHandler
    public void onSetCommandBlock(PacketReceiveEvent event, GrimPlayer player, ServerboundSetCommandBlockPacket packet) {
        processGenericReceive(event, player);
    }

    @GrimPacketHandler
    public void onSetCommandMinecart(PacketReceiveEvent event, GrimPlayer player, ServerboundSetCommandMinecartPacket packet) {
        processGenericReceive(event, player);
    }

    @GrimPacketHandler
    public void onSetStructureBlock(PacketReceiveEvent event, GrimPlayer player, ServerboundSetStructureBlockPacket packet) {
        processGenericReceive(event, player);
    }

    @GrimPacketHandler
    public void onPlaceRecipe(PacketReceiveEvent event, GrimPlayer player, ServerboundPlaceRecipePacket packet) {
        processInterveningReceive(event, player);
    }

    @GrimPacketHandler
    public void onContainerButtonClick(PacketReceiveEvent event, GrimPlayer player, ServerboundContainerButtonClickPacket packet) {
        processGenericReceive(event, player);
    }
    ...
    @GrimPacketHandler
    public void onSetBeacon(PacketReceiveEvent event, GrimPlayer player, ServerboundSetBeaconPacket packet) {
        processInterveningReceive(event, player);
    }

    @GrimPacketHandler(packetClass = "net.minecraft.network.protocol.game.ServerboundPickItemFromBlockPacket")
    public void onPickItemFromBlock(PacketReceiveEvent event, GrimPlayer player, Packet<?> packet) {
        processInterveningReceive(event, player);
    }

    @GrimPacketHandler(packetClass = "net.minecraft.network.protocol.game.ServerboundPickItemFromEntityPacket")
    public void onPickItemFromEntity(PacketReceiveEvent event, GrimPlayer player, Packet<?> packet) {
        processInterveningReceive(event, player);
    }
    ...
    @GrimPacketHandler
    public void onSignUpdate(PacketReceiveEvent event, GrimPlayer player, ServerboundSignUpdatePacket packet) {
        processInterveningReceive(event, player);
    }
    ...
    @GrimPacketHandler(packetClass = "net.minecraft.network.protocol.game.ServerboundPlayerLoadedPacket")
    public void onPlayerLoaded(PacketReceiveEvent event, GrimPlayer player, Packet<?> packet) {
        processPlayerLoadedReceive(event, player);
    }

    private void processPlayerLoadedReceive(PacketReceiveEvent event, GrimPlayer player) {
        if (event.getConnectionState() != ConnectionProtocol.PLAY) return;
    ...
    private void processGenericReceive(PacketReceiveEvent event, GrimPlayer player) {
        if (event.getConnectionState() != ConnectionProtocol.PLAY) return;
        processNonMovementReceiveAfterPlayGate(event, player);
    }

    private void processInterveningReceive(PacketReceiveEvent event, GrimPlayer player) {
        if (event.getConnectionState() != ConnectionProtocol.PLAY) return;
        clearPendingVehicleMoveForInterveningPacket(player);
        player.checkManager.dispatchDecodedReceiveObservers(event);
        player.checkManager.dispatchOrderedReceive(event);
    ...
    private void processNonMovementReceiveAfterPlayGate(PacketReceiveEvent event, GrimPlayer player) {
        clearPendingVehicleMoveForInterveningPacket(player);
    ...
    private void processMovePlayerReceive(PacketReceiveEvent event, GrimPlayer player, ServerboundMovePlayerPacket packet) {
        if (event.getConnectionState() != ConnectionProtocol.PLAY) return;
    ...
    private boolean shouldIgnoreTranslatedBedrockMovement(GrimPlayer player, boolean passengerRotationTickPacket) {
    ...
    private void processMoveVehicleReceive(PacketReceiveEvent event, GrimPlayer player, ServerboundMoveVehiclePacket packet) {
        if (event.getConnectionState() != ConnectionProtocol.PLAY) return;
        ...
        if (player.isBedrockMovement()) {
            ...
            if (!teleportData.isTeleport()
                ...
                // Grim-owned correction boundaries still apply.
                event.setCancelled(true);
    ...
    private boolean shouldBlockVehicleMovementForSetback(GrimPlayer player, TeleportAcceptData teleportData) {
    ...
    private Vec3 currentVehiclePhysicalPosition(GrimPlayer player, PacketEntity root, Vec3 fallback) {
    ...
    private PacketEntity currentVehicleRoot(GrimPlayer player, boolean fromClientTick) {
    ...
    @Nullable
    private PacketEntity bufferedLocalAuthoritativeRoot(GrimPlayer player, @Nullable PacketEntity packetRoot) {
    ...
    private boolean isBufferedLocalAuthoritativeRoot(GrimPlayer player, @Nullable PacketEntity root) {
    ...
    private void processPlayerActionReceive(PacketReceiveEvent event, GrimPlayer player, ServerboundPlayerActionPacket packet) {
        if (event.getConnectionState() != ConnectionProtocol.PLAY) return;
    ...
    private void processUseItemOnReceive(PacketReceiveEvent event, GrimPlayer player, ServerboundUseItemOnPacket packet) {
        if (event.getConnectionState() != ConnectionProtocol.PLAY) return;
        player.compensatedWorld.advanceClientPredictionSequence();
        clearPendingVehicleMoveForInterveningPacket(player);
        dispatchPrePredictionReceive(event, player);
        ...
        final ac.grim.grimac.utils.latency.CompensatedWorld compensatedWorld = player.compensatedWorld;
    ...
    private void processUseItemReceive(PacketReceiveEvent event, GrimPlayer player, ServerboundUseItemPacket packet) {
        if (event.getConnectionState() != ConnectionProtocol.PLAY) return;
        player.compensatedWorld.advanceClientPredictionSequence();
        clearPendingVehicleMoveForInterveningPacket(player);
        dispatchPrePredictionReceive(event, player);
    ...
    private void processClientTickEndReceive(PacketReceiveEvent event, GrimPlayer player) {
        if (event.getConnectionState() != ConnectionProtocol.PLAY) return;
        dispatchPrePredictionReceive(event, player);
        dispatchReceiveHandlers(event, player);
    ...
    private void clearPendingVehicleMoveForInterveningPacket(GrimPlayer player) {
    ...
    private void dispatchPrePredictionReceive(PacketReceiveEvent event, GrimPlayer player) {
        player.checkManager.dispatchPrePredictionReceive(event);
    }

    private void dispatchReceiveHandlers(PacketReceiveEvent event, GrimPlayer player) {
    ...
    private void clearTransientPacketState(GrimPlayer player) {
    ...
    private void handleFlying(GrimPlayer player, double x, double y, double z, float yaw, float pitch, boolean hasPosition, boolean hasLook, boolean onGround, TeleportAcceptData teleportData) {
        player.serverOpenedInventoryThisTick = false;
        ...
        if (hasPosition && !player.packetStateData.lastPacketWasOnePointSeventeenDuplicate) {
            ...
            final ac.grim.grimac.manager.player.MovementData movementData = player.getMovementData();
        ...
        if (hasPosition) {
            ...
            final ac.grim.grimac.utils.data.packetentity.PacketEntitySelf selfEntity = player.compensatedEntities.getSelf();
    ...
    private static void applyClientBreakPrediction(GrimPlayer player, BlockPos blockPosition) {
    ...
    private static void dispatchPlaySend(PacketSendEvent event, GrimPlayer player) {
    ...
    private static final class CheckManagerSendForwarder implements PacketSendHandler<Packet<?>> {
        @Override
        public void handle(PacketSendEvent event, GrimPlayer player, Packet<?> packet) {
