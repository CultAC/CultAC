...
import ac.cult.cultac.bedrock.prediction.simulation.collision.BedrockBlockCollisionResolver;
...
import ac.cult.cultac.bedrock.prediction.simulation.postmove.BedrockLiquidClimbOutMovement;
    ...
    public void acceptedPostMoveBounceVelocityWinsBeforeGenericVerticalCollisionReset() {
        BlockCollisionWorld world = new BlockCollisionWorld(List.of(
                PlacedBlockCollision.manual(
                        ...
                        List.of(new ac.cult.cultac.bedrock.prediction.geometry.WorldCollisionBox(
                                302.0D,
                                82.0D,
                                -91.0D,
                                303.0D,
