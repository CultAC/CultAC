...
public final class GrimNetworkManagerBundleSilencingTest {
    @Test
    public void bundleSilencingTracksOnlyObservedLeavesByIdentity() throws Exception {
        GrimNetworkManager manager = new GrimNetworkManager();
