...
public final class SyncedToolTagCompensationTest {
    ...
    public void dynamicClientTagControlsIndependentToolRuleProperties() throws Exception {
        ...
        try {
            Identifier tagId = Identifier.fromNamespaceAndPath("grim", "test_tool_blocks");
    ...
    private static Object modernToolData(GrimPlayer player, Tool tool) throws Exception {
