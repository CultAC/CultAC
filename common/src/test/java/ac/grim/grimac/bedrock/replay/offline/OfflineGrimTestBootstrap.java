...
import ac.grim.grimac.utils.collisions.BedrockClientBlockShapeMappings;
...
public final class OfflineGrimTestBootstrap {
    ...
    private OfflineGrimTestBootstrap() {
    }
    ...
    public static void installConfig() {
        ...
        try {
            Field field = GrimAPI.class.getDeclaredField("configManager");
            field.setAccessible(true);
            field.set(GrimAPI.INSTANCE, configManager);
            installed = true;
        } catch (ReflectiveOperationException exception) {
            throw new IllegalStateException("failed to install offline Grim config", exception);
        }
    }
    ...
    private static void installGrimPlugin() {
        try {
            Field pluginField = GrimAPI.class.getDeclaredField("plugin");
            pluginField.setAccessible(true);
            pluginField.set(GrimAPI.INSTANCE, plugin());
        } catch (ReflectiveOperationException exception) {
            throw new IllegalStateException("failed to install offline Grim plugin", exception);
        }
    }
    ...
    private static void installPlatformLoader() {
        ...
        try {
            Field loaderField = GrimAPI.class.getDeclaredField("loader");
            loaderField.setAccessible(true);
            loaderField.set(GrimAPI.INSTANCE, loader);
        } catch (ReflectiveOperationException exception) {
            throw new IllegalStateException("failed to install offline Grim platform loader", exception);
        }
    }
    ...
    private static UnsafeValues unsafeValues() {
        ...
        OfflineGrimTestBootstrap.unsafeValues = unsafeValues;
        return OfflineGrimTestBootstrap.unsafeValues;
    }
    ...
    private static PluginManager pluginManager() {
        ...
        OfflineGrimTestBootstrap.pluginManager = (PluginManager) Proxy.newProxyInstance(
                PluginManager.class.getClassLoader(),
                new Class<?>[]{PluginManager.class},
                (proxy, method, args) -> defaultValue(method.getReturnType()));
        return OfflineGrimTestBootstrap.pluginManager;
    }
