...
import ac.grim.grimac.checks.impl.prediction.PredVector.StepCandidate;
...
import ac.grim.grimac.checks.impl.prediction.stage.uncertainty.ExternalMovementUncertainty.Snapshot;
...
public final class BedrockUncertaintyPipelineTest {
   ...
   public void bedrockEngineUsesStandardRunnerAndPreservesNoOpTrace() {
      ...
      GrimPlayer player = playerWithFireworks(false);
   ...
   private static GrimPlayer playerWithFireworks(boolean active) {
      GrimPlayer player = (GrimPlayer)Mockito.mock(GrimPlayer.class);

      try {
         Field field = GrimPlayer.class.getDeclaredField("compensatedFireworks");
