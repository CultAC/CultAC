...
public class BukkitPermissionRegistrationManager implements PermissionRegistrationManager {
     ...
     * like "cult.exempt.checkname") that are generated at runtime. Most other static permissions
     * (e.g., "cult.exempt", "cult.alerts.enable-on-join") are registered with their defaults
     ...
     *
     * @param name         The permission node to register (e.g., "cult.exempt.checkname").
